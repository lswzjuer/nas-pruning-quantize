...
def PreActResNet34(pretrained=False, progress=True,**kwargs):
    return PreActResNet(PreActBlock, [3,4,6,3],**kwargs)

def PreActResNet50(pretrained=False, progress=True,**kwargs):
    return PreActResNet(PreActBottleneck, [3,4,6,3],**kwargs)

def PreActResNet101(pretrained=False, progress=True,**kwargs):
    return PreActResNet(PreActBottleneck, [3,4,23,3],**kwargs)

def PreActResNet152(pretrained=False, progress=True, **kwargs):
