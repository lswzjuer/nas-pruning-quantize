# -*- coding: utf-8 -*-
# @Author: liusongwei
# @Date:   2020-10-03 00:16:01
# @Last Modified by:   liusongwei
# @Last Modified time: 2020-10-03 18:21:06
...
class baseBlock_res(nn.Module):
    """docstring for """
    def __init__(self, in_planes, planes, kernel_size,stride,padding,binarynum=1,
                        pooling=False,act=None,dilation=1,groups=1,bias=False):
        super(baseBlock_res, self).__init__()
...
class Lenet(nn.Module):
    def __init__(self, num_classes=10,binarynum=1):
        ...
        self.block1 = baseBlock_res(in_planes=32,planes=32,kernel_size=3,stride=1,padding=1,bias=False,
                                pooling=True,act="relu")
        self.block2 = baseBlock_res(in_planes=32,planes=32,kernel_size=3,stride=1,padding=1,bias=False,
                                pooling=True,act="relu")   
