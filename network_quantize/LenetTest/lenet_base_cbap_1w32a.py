...
# @Last Modified time: 2020-10-03 18:19:43
...
class baseBlock_1w32a(nn.Module):
    """docstring for """
    def __init__(self, in_planes, planes, kernel_size,stride,padding,binarynum=1,
                        pooling=False,act=None,dilation=1,groups=1,bias=False):
        super(baseBlock_1w32a, self).__init__()

        self.conv = Layer.BNNConv2d_1w32a(in_planes,planes,kernel_size=kernel_size,stride=stride,padding=padding,
            dilation=dilation,groups=groups,bias=bias)
...
class Lenet(nn.Module):
    def __init__(self, num_classes=10,binarynum=1):
        ...
        self.block1 = baseBlock_1w32a(in_planes=32,planes=32,kernel_size=3,stride=1,padding=1,bias=False,
                                pooling=True,act="relu")
        self.block2 = baseBlock_1w32a(in_planes=32,planes=32,kernel_size=3,stride=1,padding=1,bias=False,
                                pooling=True,act="relu")   
