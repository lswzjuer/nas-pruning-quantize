...
# @Last Modified time: 2020-10-03 21:28:57
...
class baseBlock_1w1a(nn.Module):
    """docstring for """
    def __init__(self, in_planes, planes, kernel_size,stride,padding,binarynum=1,
                        pooling=False,act=None,dilation=1,groups=1,bias=False):
        super(baseBlock_1w1a, self).__init__()
...
class Lenet(nn.Module):
    def __init__(self, num_classes=10,binarynum=1):
        ...
        self.block1 = baseBlock_1w1a(in_planes=32,planes=32,kernel_size=3,stride=1,padding=1,bias=False,
                                pooling=True,act=None)
        self.block2 = baseBlock_1w1a(in_planes=32,planes=32,kernel_size=3,stride=1,padding=1,bias=False,
                                pooling=True,act=None)   
