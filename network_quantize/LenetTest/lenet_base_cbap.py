...
# @Last Modified time: 2020-10-03 21:25:15
...
class Lenet(nn.Module):
    def __init__(self, num_classes=10,binarynum=1):
        ...
        self.block1 = baseBlock(in_planes=32,planes=32,kernel_size=3,stride=1,padding=1,bias=False,
                                pooling=True,act="relu")
        self.block2 = baseBlock(in_planes=32,planes=32,kernel_size=3,stride=1,padding=1,bias=False,
                                pooling=True,act="relu")
