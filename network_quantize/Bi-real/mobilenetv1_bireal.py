...
# @Last Modified time: 2020-10-11 16:29:29
...
class Block(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, stride=1):
        ...
        self.conv1 = Layer.BiRealConv2d_1w1a(in_planes, in_planes, kernel_size=3, stride=stride, padding=1, groups=in_planes, bias=False)
        self.bn1 = nn.BatchNorm2d(in_planes)
        self.conv2 = Layer.BiRealConv2d_1w1a(in_planes, out_planes, kernel_size=1, stride=1, padding=0, bias=False)
